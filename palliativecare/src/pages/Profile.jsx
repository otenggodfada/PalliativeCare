...
const Profile = () => {
  ...
  return (
    ...
    <div class="mx-auto w-32 h-32 relative -mt-16 border-4 border-white rounded-full overflow-hidden">
        <img className="object-cover object-center h-32" src='https://firebasestorage.googleapis.com/v0/b/palliativecare-26a3b.appspot.com/o/profile_images%2FHfKjzWJTZa?alt=media&token=75882ac3-0477-442f-b335-8447d4a4366f' alt='Woman looking front'/>
    </div>
    <div class="text-center mt-2">
        <h2 class="font-semibold">{userData['username']}</h2>
        <p class="text-gray-500">{userData['role']}</p>
    </div>
    ...
    <div class="p-4 border-t mx-8 mt-2">
        <button class="w-1/2 block mx-auto rounded-full bg-gray-900 hover:shadow-lg font-semibold text-white px-6 py-2">Verify</button>
    </div>
</div>
</>
  );
