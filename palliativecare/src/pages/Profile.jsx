      ...
      <div class="max-w-2xl mx-4 sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto mt-16 bg-white shadow-xl rounded-lg text-gray-900">
        ...
        <ul class="py-4 mt-2 text-gray-700 flex items-center justify-around">
          ...
          <li className="flex flex-col items-center justify-between">
            <svg
              className="w-4 fill-current text-mypink"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
            >
        ...
        <div class="p-4 border-t mx-8 mt-2">
          <button class="w-1/2 block mx-auto rounded-full bg-mypink hover:shadow-lg font-semibold text-white px-6 py-2">
            Verify
          </button>
        </div>
      </div>
